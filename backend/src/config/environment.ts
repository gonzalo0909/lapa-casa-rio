...
if (!env.DATABASE_URL) {
  // fail-fast en producción -- consistente con JWT_SECRET/ENCRYPTION_KEY/ADMIN_PASSWORD_HASH,
  // en vez de levantar un servidor que va a fallar en el primer query real.
  if (isProd) {
