...
export const depositMpCardHandler = async (
  ...
  try {
    ...
    // Idempotencia con lock a nivel de reserva: SELECT FOR UPDATE dentro de una
    // transacción garantiza que dos requests simultáneos no pasen el check al
    // mismo tiempo y generen dos cobros en MP.
