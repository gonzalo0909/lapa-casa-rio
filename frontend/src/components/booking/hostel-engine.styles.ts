...
.he-brand span{font-family:var(--font-cormorant),Georgia,serif;font-weight:300;font-style:italic;text-transform:none;color:#3D2A05;display:block;font-size:.62em;letter-spacing:.06em;margin-top:.12em;opacity:1;text-shadow:0 1px 3px rgba(0,0,0,.5)}
